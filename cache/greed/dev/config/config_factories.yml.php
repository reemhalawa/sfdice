...
$logger = new sfFileLogger($this->dispatcher, array_merge(array('auto_shutdown' => false), array (
  'level' => 'debug',
  'file' => 'C:\\xampp\\htdocs\\sfdice\\log/greed_dev.log',
)));
$this->factories['logger']->addLogger($logger);
  ...
  'cache_dir' => 'C:\\xampp\\htdocs\\sfdice\\cache\\greed\\dev\\i18n',
  'lifetime' => 31556926,
  'prefix' => 'C:\\xampp\\htdocs\\sfdice\\apps\\greed/i18n',
));
...
'auto_shutdown' => false, 'session_id' => $this->getRequest()->getParameter('symfony'),
  ...
  'automatic_cleaning_factor' => 0,
  'cache_dir' => 'C:\\xampp\\htdocs\\sfdice\\cache\\greed\\dev\\template',
  'lifetime' => 86400,
  'prefix' => 'C:\\xampp\\htdocs\\sfdice\\apps\\greed/template',
)));
